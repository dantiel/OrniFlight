...
</select></span>, skaliert mit &cuberoot;Drehmoment.
Höher ist besser. Spaltenköpfe anklicken zum Sortieren — <strong>Shift+Klick</strong> für Mehrfachsortierung. Ergänzungen per PR an `_data/servos.yml`.
