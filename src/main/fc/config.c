...
{
    // OrniFlight: only MIXER_SERVO_ORNITHOPTER supported
    if (mixerConfigMutable()->mixerMode != MIXER_SERVO_ORNITHOPTER) {
        mixerConfigMutable()->mixerMode = MIXER_SERVO_ORNITHOPTER;
    }
