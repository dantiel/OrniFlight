...
// PG_SERVO_CONFIG
    ...
    { "channel_forwarding_start",   VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { AUX1, MAX_SUPPORTED_RC_CHANNEL_COUNT }, PG_SERVO_CONFIG, offsetof(servoConfig_t, channel_forwarding_start_channel) },
#endif
...
// PG_TIMECONFIG
    ...
    { "servo_mount_height",     VAR_INT8 | MASTER_VALUE | MODE_ARRAY, .config.array.length = MAX_ORNITHOPTER_PAIRS, PG_SERVO_CONFIG, offsetof(servoConfig_t, servo_mount_height) },
    { "servo_pair_amplitude",   VAR_UINT8 | MASTER_VALUE | MODE_ARRAY, .config.array.length = MAX_ORNITHOPTER_PAIRS, PG_SERVO_CONFIG, offsetof(servoConfig_t, servo_pair_amplitude) },
    ...
    { "servo_travel_time_ms",   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 30, 500 }, PG_SERVO_CONFIG, offsetof(servoConfig_t, servo_travel_time_ms) },
